 ...
 */
class ReservationItem extends ElementItem
{
    const MODEL_CLASS = Reservation::class;
     ...
     * @return string
     */
    public function getPageUrl($sPageCode = 'reservation')
    {
        //Get URL params
    ...
    public function getPageParamList($sPageCode) : array
    {
        ...
        $arParamList = PageHelper::instance()->getUrlParamList($sPageCode, 'ReservationPage');
